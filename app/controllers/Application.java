...
public class Application extends Controller {
  ...
  public static Result index() {
    return ok(Index.render(ContactDB.getContacts(), "Index", Secured.isLoggedIn(ctx()), Secured.getUserInfo(ctx())));
  }
  ...
  public static Result newContact(long id) {
    ...
    return ok(NewContact.render(formData, telephoneTypeMap, "New", Secured.isLoggedIn(ctx()), Secured.getUserInfo(ctx())));
  }
  ...
  public static Result postContact() {
    ...
    if (formData.hasErrors()) {
      ...
      return badRequest(NewContact.render(formData, telephoneTypeMap, "New", Secured.isLoggedIn(ctx()), Secured.getUserInfo(ctx())));
    }
    else {
